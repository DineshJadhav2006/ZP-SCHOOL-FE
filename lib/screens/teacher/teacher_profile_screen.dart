                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      children: [
                        ...
                        _buildInfoGrid([
                          _infoTile("Phone", teacher!["mobile_number"] ?? "-", Icons.phone_outlined, Colors.green),
                          _infoTile("Gender", teacher!["gender"] ?? "-", Icons.person_outline, Colors.pink),
                          _infoTile("Date of Birth", formatDate(teacher!["date_of_birth"]), Icons.cake_outlined, Colors.orange),
                        ]),
                        SizedBox(height: 24),
                        _buildSectionHeader("Professional Information"),
                        _buildInfoGrid([
                          _infoTile("Qualification", teacher!["qualification"] ?? "-", Icons.school_outlined, Colors.blue),
                          _infoTile("Joining Date", formatDate(teacher!["joining_date"]), Icons.calendar_today_outlined, Colors.indigo),
                        ]),
                        SizedBox(height: 40),
